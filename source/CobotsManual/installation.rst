...
Scatola di Controllo Mini Integrata (Specifiche Carico Uscita DO)
********************************************************************************************

Contesto
""""""""""""""""""""""""""""
Quando la scatola di controllo a tensione ampia alimenta una specifica elettrovalvola da 6.5W, dopo un periodo di funzionamento (tempo totale di attivazione IO circa 3-5 minuti), il circuito a 24V sulla morsettiera IO fluttua, causando l'attivazione dell'allarme di arresto di emergenza del robot.

Descrizione del Problema
"""""""""""""""""""""""""""""""""""""

1) Test di verifica con un'elettrovalvola da 7W hanno mostrato la temperatura del transistor di uscita DO a 158.1℃;
2) Il funzionamento prolungato a questa temperatura comporta il rischio di cortocircuito e bruciatura, che potrebbe attivare la protezione del chip limitatore di corrente a 24V;
3) Il chip limitatore di corrente alimenta le uscite DO e i relè a guida forzata, ecc. Quando i relè a guida forzata si scollegano, il corpo principale perde alimentazione, provocando un arresto di emergenza.

Causa Principale
"""""""""""""""""""""""""""""""""""""
L'uscita digitale (DO) della scatola di controllo a tensione ampia utilizza un design a circuito push-pull. Il transistor inferiore (transistor PNP) opera nella regione lineare e non è completamente saturo, causando un aumento della caduta di tensione sul transistor all'aumentare del carico.

Misure Temporanee
"""""""""""""""""""""""""""""""""""""
Controllare le uscite DO utilizzando l'isolamento a relè, ovvero collegando un relè esterno a bassa potenza (circa 40mA) per controllare carichi ad alta potenza come le elettrovalvole.

Soluzione Permanente
"""""""""""""""""""""""""""""""""""""
Sostituire il transistor PNP nel circuito push-pull dell'uscita DO con un transistor Darlington PNP. Questa modifica garantisce che il transistor inferiore nell'uscita push-pull operi nella regione di saturazione. I parametri di carico specifici sono mostrati nella tabella sottostante.

Contenuto Aggiornato Manuale Utente
"""""""""""""""""""""""""""""""""""""
Sono state aggiunte le specifiche di carico DO per le scatole di controllo CA a tensione stretta/CC. Il seguente contenuto è aggiunto alla fine della sezione "3.5.6. Specifiche Generali per Tutti gli I/O Digitali" nel manuale utente.

Le specifiche elettriche per i carichi DO digitali sono mostrate nella tabella seguente.

.. centered:: Tabella 3.3-7 Specifiche Elettriche Carico DO Digitale Singolo Canale
