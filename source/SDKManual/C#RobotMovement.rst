...
Inizio Trasformazione dei Punti del Sistema di Coordinate del Pezzo
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
.. code-block:: c#
    :linenos:

    /**
    * @brief  Inizio della trasformazione dei punti del sistema di coordinate del pezzo
    * @param  [in] workpieceID Numero del pezzo [0-14]
    * @return  Codice errore, 0 in caso di successo
    */
    public int WorkPieceTrsfStart(int workpieceID)
    
Fine Trasformazione dei Punti del Sistema di Coordinate del Pezzo
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
.. code-block:: c#
    :linenos:

    /**
    * @brief  Fine della trasformazione dei punti del sistema di coordinate del pezzo
    * @return  Codice errore, 0 in caso di successo
    */
    public int WorkPieceTrsfEnd()
        
Esempio di Codice per la Trasformazione dei Punti del Sistema di Coordinate del Pezzo
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
.. code-block:: c#
    :linenos:
    ...
    public int TestWorkPieceTrsf()
    {
        ...
        // ===== Sistema di Coordinate 2 (dopo trasformazione) =====
        robot.MoveJ(j1, d1, tool, workpiece, 100, 100, 100, ex, -1, 0, zeroOff);
        robot.MoveJ(j2, d2, tool, workpiece, 100, 100, 100, ex, blend, 0, zeroOff);
        robot.MoveL(j3, d3, tool, workpiece, 10, 100, 100, blend, 0, ex, 0, 1, zeroOff, 0, 90);
        robot.MoveC(j4, d4, tool, workpiece, 100, 100, ex, 0, zeroOff,
