...
.. csv-table:: 
    ...
    "Parametri obbligatori", "- ``id``: Numero del sistema di coordinate, 20-39 corrispondono ai sistemi di coordinate degli utensili esterni 0-19;
    - ``etcp``: [x,y,z,rx,ry,rz] Sistema di coordinate dell'utensile esterno, unità [mm][°];
    - ``etool``: [x,y,z,rx,ry,rz] Sistema di coordinate dell'utensile terminale, unità [mm][°];"
    "Parametri predefiniti", "Nessuno"
    "Valore di ritorno", "Codice di errore Successo-0  Fallimento- errcode"
...
.. csv-table:: 
    ...
    "Prototipo", "``PhotoelectricSensorTCPCalibration(self, luaFile, offsetX)``"
    "Descrizione", "Calibrazione TCP Sensore Foto-elettrico"
    "Parametri Richiesti", "
    - ``luaFile``: Percorso programma Lua per calibrazione automatica: Per - 'FR_CalibrateTheToolTcp.lua';
...
.. csv-table:: 
    ...
    "Prototipo", "``SetSpeedInstant(self, vel)``"
    "Descrizione", "Impostazione della velocità in tempo reale (frame di comando, bassa latenza)"
    "Parametri Obbligatori", "
    - ``vel``: Percentuale di velocità, intervallo [0~100]"
    "Parametri Predefiniti", "Nessuno"
    "Valore di Ritorno", "
...
.. csv-table:: 
    ...
    "Prototipo", "``SetWeaveOffsetRT(self, offset)``"
    "Descrizione", "Imposta l'offset in tempo reale della tessitura"
    "Parametri Obbligatori", "
    - ``offset``: Offset in tempo reale [x,y,z,rx,ry,rz], unità [mm, °]"
    "Parametri Predefiniti", "Nessuno"
    "Valore di Ritorno", "
    - Codice errore, 0-successo; diverso da zero-errore"
