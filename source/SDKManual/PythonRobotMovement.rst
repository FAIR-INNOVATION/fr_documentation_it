...
.. csv-table:: 
    ...
    "Prototipo", "``WorkPieceTrsfStart(self, workpieceID)``"
    "Descrizione", "Inizio della trasformazione dei punti del sistema di coordinate del pezzo"
    "Parametri Obbligatori", "
    - ``workpieceID``: Numero del pezzo [0-14]
    "
    "Parametri Predefiniti", "Nessuno"
...
.. csv-table:: 
    ...
    "Prototipo", "``WorkPieceTrsfEnd((self)``"
    "Descrizione", "Fine della trasformazione dei punti del sistema di coordinate del pezzo"
    "Parametri Obbligatori", "Nessuno"
    "Parametri Predefiniti", "Nessuno"
    "Valore di Ritorno", "Codice errore, 0-successo; diverso da zero-errore"    
